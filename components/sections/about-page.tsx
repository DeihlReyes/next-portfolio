...
const AboutPage = () => {
    return (
        <section id='about' className="flex flex-col justify-center items-center px-8 py-16 md:py-32">
            <div className="flex flex-col gap-12 md:flex-row items-center max-w-6xl">
